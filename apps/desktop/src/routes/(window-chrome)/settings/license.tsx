					...
					<div class="flex justify-center items-center w-full h-screen">
						<div class="flex flex-col items-center p-6 mx-auto space-y-3 w-full max-w-md text-white rounded-3xl border bg-gray-2 border-gray-3">
							...
							<p class="text-center text-gray-11">
								{t("settings.license.pro.description")}
							</p>
						</div>
					</div>
				</Match>
							...
							<div class="space-y-6">
								...
								<div>
									<label class="block mb-2 text-sm text-gray-12">
										{t("settings.license.commercial.licenseKey")}
									</label>
									...
									{(expiry) => (
										<div class="space-y-1">
											<label class="text-sm text-gray-12">
												{t("settings.license.commercial.expires")}
											</label>
				...
				<div class="flex flex-col md:flex-row">
					...
					>
						...
						<div class="space-y-1 text-center">
							...
							<p class="mt-2 text-sm text-[--text-tertiary]">
								{t("settings.license.commercial.forCommercialUse")}
							</p>
						</div>
						<div class="flex flex-col justify-center items-center mt-5">
							...
							<p class="text-[16px] font-medium text-gray-11">
								{t(
									isCommercialAnnual()
										? "settings.license.purchase.billedAnnually"
										: "settings.license.purchase.oneTimePayment",
								)}
							</p>
						</div>
						<div
						...
						>
							<p class="text-xs text-gray-12">
								{t("settings.license.purchase.switchTo", {
									plan: t(
										isCommercialAnnual()
											? "settings.license.purchase.plan.lifetime"
											: "settings.license.purchase.plan.yearly",
									),
								})}{" "}
						...
						>
							{openCommercialCheckout.isPending
								...
								: t("settings.license.purchase.purchase")}
						</Button>
					</div>
					...
					<div class="flex flex-col gap-4 justify-center items-center p-5 rounded-t-none rounded-b-xl border border-t-0 md:border-t md:border-l-0 md:rounded-bl-none md:rounded-tr-xl md:rounded-br-xl md:w-1/2 border-gray-3">
						<ul class="flex flex-col gap-2 list-none">
							{(
								[
									"settings.license.purchase.features.commercialUse",
									"settings.license.purchase.features.communitySupport",
									"settings.license.purchase.features.localOnly",
									"settings.license.purchase.features.perpetualOption",
								] as const
							).map((featureKey) => (
