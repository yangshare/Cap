...
export default function AppsTab() {
	...
	const apps = [
		{
			name: t("settings.integrations.s3.name"),
			description: t("settings.integrations.s3.description"),
	...
	return (
		<div class="p-4 space-y-4">
			<div class="flex flex-col pb-4 border-b border-gray-2">
				<h2 class="text-lg font-medium text-gray-12">{t("settings.integrations.title")}</h2>
				...
				{(app) => (
					<div class="px-4 py-2 rounded-lg border bg-gray-2 border-gray-3">
						<div class="flex justify-between items-center pb-2 mb-3 border-b border-gray-3">
							...
							>
								{app.pro && !isPro() ? t("settings.integrations.button.upgrade") : t("settings.integrations.button.configure")}
							</Button>
						</div>
